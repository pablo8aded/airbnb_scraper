...
api_key = 'mx0vglekTts7trdBW2'  

# Function to fetch cryptocurrency data from CoinGecko
def get_crypto_data(crypto):
    try:
        #
        response = requests.get(f'https://api.mexc.com/api/v3/ticker/price?symbol={crypto}')
...
app = ApplicationBuilder().token('7297065030:AAEgxkeYSuucVD67Jz_Hy6luJ6zsupOasmk').build()
